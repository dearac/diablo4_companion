...
describe('ScanReplayRunner', () => {
  it('should replay a recording and produce a ReplayResult', () => {
    const recording: ScanRecording = {
      ...
      parsedItem: {
        slot: 'Helm', itemName: 'Test Helm', itemType: 'Legendary',
      ...
      buildSlot: {
        slot: 'Helm', itemName: null, itemType: 'Legendary',
        requiredAspect: null, affixes: [{ name: 'Strength', isGreater: false }],
        implicitAffixes: [], temperedAffixes: [], greaterAffixes: [],
        masterworkPriority: [], rampageEffect: null, feastEffect: null,
        socketedGems: []
      },
